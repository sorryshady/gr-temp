            ...
            <div ref={formRef}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-orange-500 text-white font-medium py-4 px-6 rounded-lg hover:bg-orange-600 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div ref={infoRef}>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Follow our journey and stay updated on our latest ventures and collaborations.
                  </p>
                  <div className="flex space-x-4">
                    ...
                    >
                      <svg className="w-5 h-5 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10s4.477 10 10 10 10-4.477 10-10S15.523 0 10 0zm4.896 4.896a.896.896 0 11-1.792 0 .896.896 0 011.792 0zM10 6.7a3.3 3.3 0 100 6.6 3.3 3.3 0 000-6.6zm0 5.45a2.15 2.15 0 110-4.3 2.15 2.15 0 010 4.3zm4.108-9.85H5.892C2.633.3.3 2.633.3 5.892v8.216C.3 17.367 2.633 19.7 5.892 19.7h8.216c3.259 0 5.592-2.333 5.592-5.592V5.892C19.7 2.633 17.367.3 14.108.3z" clipRule="evenodd" />
                      </svg>
                    </a>
                    <a
                ...
                <div className="p-6 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-600 text-sm">
                    ...
                    For urgent matters, please indicate the priority in your message.
                  </p>
                </div>
              </div>
            </div>
